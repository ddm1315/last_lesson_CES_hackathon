...
- `src/content/puzzles.ts` contains the typed stage configuration, narrative, resources, hints, institution variants, validation, and archive entries.
...
Developer mode is available in local development at `/?dev=1`. It can jump stages from the left mission sidebar or dev panel, change the test institution, complete the archive, inspect local state, and reset progress.
